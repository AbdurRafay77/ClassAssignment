...
const splicedElements = originalArray.splice(2, 2); // Removes 2 elements starting from index 2
...
const slicedArray = originalArray.slice(1, 4); // Extracts elements from index 1 to index 3 (exclusive)
